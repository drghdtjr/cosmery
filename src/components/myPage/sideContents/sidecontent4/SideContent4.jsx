...
import styles from "./SideContent4.module.css";
import DatePicker from "react-datepicker";
import "react-datepicker/dist/react-datepicker.css";
import calendarIcon from "../../../../assets/calendar.svg"; // 본인 아이콘 경로로 바꿔주세요

const SideContent4 = ({ title, head1, head2, head3, head4 }) => {
  ...
  return (
    <div className={styles.contentWrapper}>
      ...
      <div className={styles.tableHead}>
        <div className={styles.content1Head1}>{head1}</div>
        <div className={styles.content1Head2}>{head2}</div>
        <div className={styles.content1Head3}>{head3}</div>
        <div className={styles.content1Head4}>{head4}</div>
      </div>
